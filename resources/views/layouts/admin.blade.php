...
<html lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/favicon-16x16.png">
    <link rel="manifest" href="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="<?php echo URL::to('/'); ?>/coreui/dist/assets/favicon/ms-icon-144x144.png">
    <meta name="theme-color" content="#ffffff">
    <!-- Vendors styles-->
    <link rel="stylesheet" href="<?php echo URL::to('/'); ?>/coreui/dist/vendors/simplebar/css/simplebar.css">
    <link rel="stylesheet" href="<?php echo URL::to('/'); ?>/coreui/dist/css/vendors/simplebar.css">
    <!-- Main styles for this application-->
    <link href="<?php echo URL::to('/'); ?>/coreui/dist/css/style.css" rel="stylesheet">
    <!-- We use those styles to show code examples, you should remove them in your application.-->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/prismjs@1.23.0/themes/prism.css">
    <link href="css/examples.css" rel="stylesheet">
    
    <link href="<?php echo URL::to('/'); ?>/coreui/dist/vendors/@coreui/chartjs/css/coreui-chartjs.css" rel="stylesheet">
  </head>
  <body>
...
<script src="<?php echo URL::to('/'); ?>/coreui/dist/vendors/@coreui/coreui/js/coreui.bundle.min.js"></script>
<script src="<?php echo URL::to('/'); ?>/coreui/dist/vendors/simplebar/js/simplebar.min.js"></script>
<!-- Plugins and scripts required by this view-->
<script src="<?php echo URL::to('/'); ?>/coreui/dist/vendors/chart.js/js/chart.min.js"></script>
<script src="<?php echo URL::to('/'); ?>/coreui/dist/vendors/@coreui/chartjs/js/coreui-chartjs.js"></script>
<script src="<?php echo URL::to('/'); ?>/coreui/dist/vendors/@coreui/utils/js/coreui-utils.js"></script>
<script src="<?php echo URL::to('/'); ?>/coreui/dist/js/main.js"></script>
<!-- ./wrapper -->
